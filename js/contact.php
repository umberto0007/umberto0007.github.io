...
$subject ="Новая заявка с сайта umberto0007.github.io";
...
$header .= "From: Новая заявка <info@lesson-web.ru>\n\n";	
$mail = mail("info@lesson-web.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
